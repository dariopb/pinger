...
// Some code autogenerated and then modified, some added by hand.
...
func ResizePseudoConsole(hPc syscall.Handle, coord *COORD) error {
...
func CreatePseudoConsole(hIn, hOut syscall.Handle) (syscall.Handle, error) {
